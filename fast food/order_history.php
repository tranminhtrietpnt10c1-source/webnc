...
function getStatusInfo($status) {
    $statuses = [
        ...
        'confirmed' => ['class' => 'status-confirmed', 'text' => 'Đang chuẩn bị', 'icon' => 'fa-refresh'],
        'shipped' => ['class' => 'status-shipped', 'text' => 'Đơn hàng đang đến', 'icon' => 'fa-truck'],
...
<head>
    ...
    <style>
        ...
        .status { padding: 5px 12px; border-radius: 20px; font-size: 12px; font-weight: bold; display: inline-flex; align-items: center; gap: 5px; }
        ...
        .pagination .page-link { color: #ffbe33; }
        .pagination .page-item.active .page-link { background-color: #ffbe33; border-color: #ffbe33; color: white; }
        ...
        <div class="order-history-container">
            <?php if (empty($orders)): ?>
                <div class="empty-order">
                    ...
                    <a href="menu.php" class="btn-view" style="margin-top: 20px;">Xem thực đơn</a>
                </div>
            <?php else: ?>
                ...
                <div class="text-center mt-4">
                    <a href="menu.php" class="btn-view">Tiếp tục mua hàng</a>
                </div>
            <?php endif; ?>
        </div>
    </div>
