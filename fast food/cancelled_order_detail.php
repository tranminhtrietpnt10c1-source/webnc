    ...
    <div class="container">
        ...
        <div class="order-detail-container">
            ...
            <div class="order-info-section">
                <h4 class="info-title"><i class="fa fa-truck"></i> Thông tin giao hàng</h4>
                <div class="info-grid">
                    <div class="info-item"><div class="info-label">Người nhận</div><div class="info-value"><?= htmlspecialchars($order_info['customer_name'] ?? $user_info['full_name']) ?></div></div>
                    <div class="info-item"><div class="info-label">Số điện thoại</div><div class="info-value"><?= htmlspecialchars($order_info['customer_phone'] ?? $user_info['phone'] ?? '') ?></div></div>
            ...
            <div class="order-info-section">
                <h4 class="info-title"><i class="fa fa-cutlery"></i> Chi tiết đơn hàng</h4>
                <div class="table-responsive">
                    <table class="product-table">
                        <thead>
                            <tr><th>Sản phẩm</th><th>Đơn giá</th><th>Số lượng</th><th>Thành tiền</th> </thead>
                        <tbody>
                            <?php foreach ($order_details as $item): ?>
                            <tr>
                                <td><div class="d-flex align-items-center"><?php if (!empty($item['product_image'])): ?><img src="<?= htmlspecialchars($item['product_image']) ?>" class="product-image mr-3"><?php endif; ?><span class="product-name"><?= htmlspecialchars($item['product_name']) ?></span></div></td>
                ...
                <div class="summary-box">
                    <div class="summary-row"><span>Tạm tính</span><span><?= formatCurrency($order_info['total_amount']) ?></span></div>
                    <div class="summary-row"><span>Phí vận chuyển</span><span><?= formatCurrency($order_info['shipping_fee'] ?? 0) ?></span></div>
                    <div class="summary-row total"><span>Tổng cộng</span><span><?= formatCurrency($final_amount) ?></span></div>
                </div>
            </div>
        </div>
